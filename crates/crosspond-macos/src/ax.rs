//! Ambient Accessibility reads for selected text and the focused window title.
//!
//! Computer-use actions go through cua-driver. `unsafe` stays here: these are C
//! APIs from the ApplicationServices framework.
