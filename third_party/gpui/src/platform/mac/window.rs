...
extern "C" fn window_did_change_key_status(this: &Object, selector: Sel, _: id) {
    ...
    //
    // Drop the lock first: AppKit delivers windowDidResignKey synchronously and
    // re-enters this function. parking_lot::Mutex is not reentrant, so holding it
    // across resignKeyWindow deadlocks the main thread (zed#51035 / Crosspond ANR).
