...
Current phase: **Knowledge Vault 7 — Procedure learning**.

Out of scope until later phases: Knowledge Vault Phase 8, drag, `kill_app`, exposing cua-driver’s full catalog, signing/notarization.
