...
Current phase: **Knowledge Vault 2 — Search index**.

Out of scope until later phases: Knowledge Vault Phases 3–8, drag, `kill_app`, exposing cua-driver’s full catalog, signing/notarization.
