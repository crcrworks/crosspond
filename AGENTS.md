...
Current phase: **Knowledge Vault complete (Phases 0–8)**.
...
- `[patch.crates-io]` → `third_party/gpui` drops the window-state lock before `resignKeyWindow` (zed#51035) and keeps Japanese IME attached on PopUp panels. Do not vendor Zed `main`.
