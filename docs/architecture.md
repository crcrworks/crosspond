...
Option+Space
 ...
 Enter / start_task(+capsule, mentions) ──mpsc──►  stage Finder files into scratch input/ only if selected
        ...
        │                      honor @vault-query/@vault-save/@vault-later/@screen/@computer/@app/@files/@calendar/@search
